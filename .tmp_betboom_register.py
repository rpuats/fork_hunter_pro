...
async def main():
    async with async_playwright() as pw:
        ...
        data = await page.evaluate("""() => ({
          hasRegister: !!globalThis.SportbookWidgetRegister,
          registerKeys: globalThis.SportbookWidgetRegister ? Object.keys(globalThis.SportbookWidgetRegister) : [],
          sportAppExists: !!document.getElementById('sportApp'),
