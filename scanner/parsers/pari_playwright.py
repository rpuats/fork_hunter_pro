# scanner/parsers/pari_playwright.py
"""Pari Parser - Text extraction"""
import asyncio, time
...
class PariPlaywrightParser:
    name = "Pari (Playwright)"
    slug = "pari"
    urls = [
        "https://pari.ru/live/football",
        "https://pari.ru/line/football",
        "https://pari.ru/live/basketball",
        "https://pari.ru/line/basketball",
        "https://pari.ru/live/hockey",
        "https://pari.ru/line/hockey",
        "https://pari.ru/live/tennis",
        "https://pari.ru/line/tennis",
        "https://pari.ru/live/volleyball",
        "https://pari.ru/line/volleyball",
        "https://pari.ru/live/baseball",
        "https://pari.ru/line/baseball",
        "https://pari.ru/live/handball",
        "https://pari.ru/line/handball",
        "https://pari.ru/live/rugby",
        "https://pari.ru/line/rugby",
        "https://pari.ru/live/table-tennis",
        "https://pari.ru/line/table-tennis",
        "https://pari.ru/live/badminton",
        "https://pari.ru/line/badminton",
    ]
    ...
    async def get_events(self) -> List[Dict]:
        ...
        for url in self.urls:
            try:
                ...
                logger.warning(f"Pari failed for {url}: {e}")
        return all_events
    ...
    async def _fetch_url(self, url: str) -> List[Dict]:
        ...
        try:
            ...
            logger.info(f"Pari ({url}): {len(events)} events")
        except Exception as e:
            logger.warning(f"Pari error: {e}")
            events = []
        finally:
            await browser.close()
        return events
    ...
    async def _extract_events(self, page, url: str) -> List[Dict]:
        try:
            ...
            logger.warning(f"Pari extraction error: {e}")
            return []
