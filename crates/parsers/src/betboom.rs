...
mod tests {
    use super::{
        ...
        FOCUSED_FOOTBALL_PROBE_TIMEOUT_BONUS_MS, FOCUSED_RUNTIME_PROBE_URLS,
        HEADLESS_KNOWN_BLOCKER_NAVIGATION_TIMEOUT_MS, HEADLESS_NAVIGATION_TIMEOUT_MS,
        HEADLESS_WAIT_MS, KNOWN_BLOCKER_LIVE_FOOTBALL_URL, KNOWN_BLOCKER_PREMATCH_FOOTBALL_URL,
        PREMATCH_FILTER_TEXT, PROBES, PROBE_RESULT_SLACK_MS, RUNTIME_PROBE_BUDGET_MS,
        RUNTIME_WALL_CLOCK_CUTOFF_MS,
    };
    use shared::Sport;
