...
impl BookmakerAccount {
    ...
    pub fn withdraw(&mut self, amount: f64) -> Result<(), String> {
        if amount > self.balance {
            return Err(format!("Insufficient balance: {} > {}", amount, self.balance));
        }
        self.balance -= amount;
        self.updated_at = Utc::now();
        Ok(())
...
mod tests {
    ...
    fn test_create_account() {
        let account = BookmakerAccount::new(
            "Pari".to_string(),
            10000.0,
            "RUB".to_string(),
        );
    ...
    #[test]
    fn test_deposit() {
        let mut account = BookmakerAccount::new(
            "Pari".to_string(),
            10000.0,
            "RUB".to_string(),
        );
    ...
    fn test_account_manager_balance() {
        ...
        let account1 = BookmakerAccount::new(
            "Pari".to_string(),
            10000.0,
            "RUB".to_string(),
        );
        let account2 = BookmakerAccount::new(
            "Fonbet".to_string(),
            5000.0,
            "RUB".to_string(),
        );
